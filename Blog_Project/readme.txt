Username (leave blank to use 'hp'): blog_project
Email address: fthmashahala@gmail.com
Password:abcd12345
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="index.html" class="menu-link">
                ...
                <div data-i18n="Analytics">User panel</div>
              </a>
            </li>

            <!-- Layouts -->
            <li class="menu-item">
              <a href="{% url 'user_register' %}" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="user register">Rgister</div>
              </a>
